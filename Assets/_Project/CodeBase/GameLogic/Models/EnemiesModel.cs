...
namespace CodeBase.GameLogic.Models
{
    public class EnemiesModel : IService
    {
        ...
        private readonly Dictionary<Guid, EnemyModel> _enemies = new Dictionary<Guid, EnemyModel>();
        ...
        public EnemyModel Add(Guid id, EnemyType enemyType)
        {
        ...
        public EnemyModel GetEnemyBy(Guid id)
        {
